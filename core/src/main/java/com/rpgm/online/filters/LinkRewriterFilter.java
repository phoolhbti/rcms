 ...
 * links with the {@link com.rpgm.online.services.LinkRewriterService}
 * for extensionless URLs depending on the System Settings configured by the user.
 */
@Component(immediate = true, metatype = true)
@Service(Filter.class)
@Properties({
    @Property(name="service.pid", value="com.rpgm.online.filters.LinkRewriterFilter", propertyPrivate=false),
