...
import com.rpgm.online.http.FakeHttpServletRequest;
import com.rpgm.online.http.FakeHttpServletResponse;
...
public class PreviewFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response,
        ...
        if ("GET".equals(method) && RPGMConstants.PAGE_TYPE_BLOG.equals(resourceType)) {
