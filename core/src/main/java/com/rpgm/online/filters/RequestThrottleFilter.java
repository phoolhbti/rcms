package com.rpgm.online.filters;
...
@Properties({
    @Property(name="service.pid", value="com.rpgm.online.filters.RequestThrottleFilter", propertyPrivate=false),
    @Property(name="service.description", value="RequestThrottleFilter", propertyPrivate=false),
    @Property(name="service.vendor", value="rpgm", propertyPrivate=false),
...
public class RequestThrottleFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response,
        ...
        if ("POST".equals(method) && path.startsWith(RPGMConstants.SERVLET_PATH_PUBLIC)) {
