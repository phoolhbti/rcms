...
import com.rpgm.online.utils.VltUtils;
import com.rpgm.online.services.PackageService;
...
public class PackageServiceImpl implements PackageService {
    ...
    /** Default package group name for rpgm backups */
    private static final String BACKUP_GROUP = "rpgm_backup";

    /** Default package version for rpgm backups */
    private static final String BACKUP_VERSION = "1.0";

    /** Default package paths for rpgm backups */
    ...
    /**
     * Delete rpgm backup package from the JCR.
     *
     * @param request The current request.
     * @param packageName The name of the package to install
     * @return true if package was installed successfully
