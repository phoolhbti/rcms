...
public class SystemSettingsServiceImpl implements SystemSettingsService {
    ...
    private static final String COMPONENT_PID = "rpgm system settings";

    /** Default value for the blog name */
    public static final String BLOG_NAME_DEFAULT_VALUE = "rpgm Sling + Sightly blog engine";
