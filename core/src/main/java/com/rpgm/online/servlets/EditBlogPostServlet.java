 ...
 */
@SlingServlet(paths = RPGMConstants.SERVLET_PATH_ADMIN + "/editblogpost")
public class EditBlogPostServlet extends SlingAllMethodsServlet {
    ...
    protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response) throws ServletException, IOException {
        ...
        properties.put(JcrConstants.JCR_PRIMARYTYPE, RPGMConstants.NODE_TYPE_PAGE);
        ...
        try {
            if (existingNode != null) {
                ...
                Node node = JcrResourceUtil.createPath(resolver.getResource(RPGMConstants.CONTENT_PATH).adaptTo(Node.class), BLOG_ROOT + path, NodeType.NT_UNSTRUCTURED, NodeType.NT_UNSTRUCTURED, true);
