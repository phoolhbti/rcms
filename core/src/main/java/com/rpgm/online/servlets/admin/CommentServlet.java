package com.rpgm.online.servlets.admin;
...
import com.rpgm.online.servlets.AdminServlet;
 ...
 */
@SlingServlet(paths = RPGMConstants.SERVLET_PATH_ADMIN + "/comment")
    ...
    protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
        ...
        try {
            ...
            for (Resource comment : comments) {
                ...
                json.put(RPGMConstants.COMMENT_PROPERTY_COMMENT,
                        properties.get(RPGMConstants.COMMENT_PROPERTY_COMMENT, String.class));
                json.put(JSON_ID, properties.get(JcrConstants.JCR_UUID, String.class));
                json.put(JSON_EDITED, properties.get(RPGMConstants.COMMENT_PROPERTY_EDITED, false));
                json.put(JSON_REPLIES, commentService.numberOfReplies(comment));
                json.put(JSON_SPAM, properties.get(RPGMConstants.COMMENT_PROPERTY_SPAM, false));
                json.put(JSON_POST, new JSONObject()
                        .put(JSON_POST_TEXT, post.getValueMap().get(RPGMConstants.COMMENT_PROPERTY_TITLE, String.class))
