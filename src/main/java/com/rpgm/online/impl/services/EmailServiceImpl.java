...
public class EmailServiceImpl implements EmailService {
    ...
    private static final String COMPONENT_PID = "RPGM email settings";
    ...
    public String getSmtpPassword() {
        ...
        return StringUtils.isNotBlank(password) ? RPGMConstants.PASSWORD_REPLACEMENT : null;
    }
